...
object RemoveSeq {
  def removeSeq[P](expr: Expr[P | PSeq]): Expr[P | PBlock] = {
    // TODO: Create simpler test case that exposes this in actual compiler
    def algebra(exprK: ExprK[P | PSeq, Expr[P | PBlock]]): ExprK[P | PBlock, Expr[P | PBlock]] = exprK match
...
// case expr : EIntK[Expr[P | PBlock]] => expr
// case expr : EBlockK[Expr[P | PBlock]] => expr
// case expr : (EIntK[Expr[P | PBlock]] | EBlockK[Expr[P | PBlock]]) => expr
